...
public class VentanaResidenciaAlumno extends javax.swing.JDialog implements IValidateTextFields {

    public VentanaResidenciaAlumno(Frame dial, boolean bln) {
        super(dial, bln);
        initComponents();
    ...
    public VentanaResidenciaAlumno(java.awt.Dialog dial, boolean bln) {
        super(dial, bln);
        initComponents();
        txtDUbicacion.setLineWrap(true);
        txtDUbicacion.setWrapStyleWord(true);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaResidenciaAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaResidenciaAlumno(new java.awt.Frame(),true).setVisible(true);
            }
        });
    }
